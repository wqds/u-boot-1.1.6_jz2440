...
void nand_read(unsigned int start_page_num, unsigned char *dest_addr, unsigned int page_length)
{
	S3C2440_NAND *nand_ctl = (S3C2440_NAND *)0x4e000000;
	unsigned int i, j;
	volatile unsigned char *data = (volatile unsigned char *)&nand_ctl->NFDATA;
...
void copy_code_to_sdram(unsigned char *src_addr, unsigned char *dest_addr, unsigned int length)
{
